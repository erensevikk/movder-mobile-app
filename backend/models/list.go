...
// List — Kullanıcının oluşturduğu film koleksiyonları (Kategoriler)
type List struct {
...
// ListItem — Bir listenin içindeki her bir film
...
// CreateListInput — Yeni bir liste oluştururken beklenen istek gövdesi
...
// AddToListInput — Bir listeye film eklerken beklenen istek gövdesi
